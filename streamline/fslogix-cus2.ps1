...
Set-ItemProperty -Path $path1 -Name $name1 -Value $value1
Set-ItemProperty -Path $path1 -Name $name8 -Value $value8
Set-ItemProperty -Path $path1 -Name $name9 -Value $value9
