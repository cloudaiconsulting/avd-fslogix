...
$name2 = "CCDLocations"
$type2 = "String"
$value2 = "type=smb,connectionString=\\sashcavdprofileswus202.file.core.windows.net\profiles;type=smb,connectionString=\\sashcavdprofilescus02.file.core.windows.net\profiles"
